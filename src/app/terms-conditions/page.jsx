export default function Page() {
  return (
    <div className="my-5 mb-20 p-10">
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to OurPlaces!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of OurPlaces{`'`}s Website, located at https://our-places.vercel.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use OurPlaces if you do not agree to take
      ...
      <p>
        ...
        {`"`}You{`"`} and
        {`"`}Your{`"`} refers to you, the person log on this website and
        compliant to the Company’s terms and conditions. {`"`}The Company{`"`},{" "}
        {`"`}Ourselves{`"`}, {`"`}We{`"`},{`"`}Our{`"`} and {`"`}Us{`"`}, refers
        to our Company. {`"`}Party{`"`}, {`"`}Parties{`"`}, or {`"`}Us{`"`},
      ...
      <p>
        We employ the use of cookies. By accessing OurPlaces, you agreed to use
        cookies in agreement with the OurPlaces{`'`}s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, OurPlaces and/or its licensors own the
        intellectual property rights for all material on OurPlaces. All
        intellectual property rights are reserved. You may access this from
        OurPlaces for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from OurPlaces</li>
        <li>Sell, rent or sub-license material from OurPlaces</li>
        <li>Reproduce, duplicate or copy material from OurPlaces</li>
        <li>Redistribute content from OurPlaces</li>
      </ul>
      ...
      <p>
        ...
        OurPlaces does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of OurPlaces,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, OurPlaces shall not be liable
      ...
      <p>
        OurPlaces reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant OurPlaces a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of OurPlaces; and (d) the link is
      ...
      <p>
        ...
        e-mail to OurPlaces. Please include your name, your organization name,
      ...
      <p>
        No use of OurPlaces{`'`}s logo or other artwork will be allowed for
